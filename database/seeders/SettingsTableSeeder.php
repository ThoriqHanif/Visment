...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'term_ends', 'description' => '7/8/2023'],
            ['type' => 'term_begins', 'description' => '7/8/2023'],
            ['type' => 'phone', 'description' => '081234556789'],
            ['type' => 'address', 'description' => 'Surakarta, Jawa Tengah, Indonesia'],
            ['type' => 'system_email', 'description' => 'viska@gmail.com'],
